...
{   
    public $has_many = array('permissions' => array('primary_key' => 'menus_id','model'=>'permission_model'));
    protected $columnTableData = ['id', 'name', 'route', 'icon', 'status', 'parent_id', 'descriptions'];
    protected $headerTableData = [
        [['data' => 'Id'], ['data' => 'Nama Menu'], ['data' => 'Route'], ['data' => 'Icon'], ['data' => 'Status'], ['data' => 'Parent Menu'], ['data' => 'Deskripsi'], ['data' => 'Aksi']],
    ];
